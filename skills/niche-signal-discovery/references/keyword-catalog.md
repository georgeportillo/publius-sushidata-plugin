...
**1. Product category keywords** — Sushidata swarm query (`/swarm/deploy/`): "Research the terminology and keywords buyers and vendors use for {target product category}."

Example for creative ops:
```bash
Sushidata swarm: "Research creative operations terminology, DAM phrases, and asset management keywords."
```

**2. Buyer pain point keywords** — Sushidata swarm query (`/swarm/deploy/`): "Research the challenges, problems, and pain points for {buyer persona}."

Example for creative teams:
```bash
Sushidata swarm: "Research the workflow challenges and pain points for creative teams and marketing teams."
```
...
**1. Tech stack discovery** — From Step 0.5 Sushidata swarm research: "What tools are common in the {buyer persona} software stack?"

Example for creative teams:
```bash
Sushidata swarm: "Research the common software tools and tech stack for creative teams and marketing teams."
Sushidata swarm: "Research the tools, integrations, and workflows common to creative operations teams using Figma or Adobe."
```
...
**1. Job role discovery** — From Step 0.5 Sushidata swarm research: "What job titles, roles, and responsibilities are common for {buyer persona}?"

Example for creative teams:
```bash
Sushidata swarm: "Research creative operations job titles, including creative director and content manager variants."
Sushidata swarm: "Research companies hiring for creative operations or brand manager roles and extract common title variants."
```
